...
type predict struct {
	...
	predictionWatchlist data.PredictionWatchlist
...
func (p predict) WatchMarket(exchange connector.ExchangeName, market prediction.Market) {
...
func (p predict) Orderbook(exchange connector.ExchangeName, market prediction.Market, outcome prediction.Outcome) (*connector.OrderBook, error) {

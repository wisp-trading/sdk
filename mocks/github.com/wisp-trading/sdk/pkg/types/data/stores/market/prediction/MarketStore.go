...
import (
	...
	connectorprediction "github.com/wisp-trading/sdk/pkg/types/connector/prediction"
...
func (_m *MarketStore) GetMarketOrderBooks(exchange connector.ExchangeName, marketID connectorprediction.MarketID) prediction.OutcomeOrderBookMap {
	...
	if rf, ok := ret.Get(0).(func(connector.ExchangeName, connectorprediction.MarketID) prediction.OutcomeOrderBookMap); ok {
...
//   - marketID connectorprediction.MarketID
...
func (_c *MarketStore_GetMarketOrderBooks_Call) Run(run func(exchange connector.ExchangeName, marketID connectorprediction.MarketID)) *MarketStore_GetMarketOrderBooks_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(connector.ExchangeName), args[1].(connectorprediction.MarketID))
	})
	return _c
}

func (_c *MarketStore_GetMarketOrderBooks_Call) Return(_a0 prediction.OutcomeOrderBookMap) *MarketStore_GetMarketOrderBooks_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MarketStore_GetMarketOrderBooks_Call) RunAndReturn(run func(connector.ExchangeName, connectorprediction.MarketID) prediction.OutcomeOrderBookMap) *MarketStore_GetMarketOrderBooks_Call {
	_c.Call.Return(run)
	return _c
}

// GetOrderBook provides a mock function with given fields: exchange, marketID, outcomeID
func (_m *MarketStore) GetOrderBook(exchange connector.ExchangeName, marketID connectorprediction.MarketID, outcomeID connectorprediction.OutcomeID) *connector.OrderBook {
	...
	if rf, ok := ret.Get(0).(func(connector.ExchangeName, connectorprediction.MarketID, connectorprediction.OutcomeID) *connector.OrderBook); ok {
...
//   - exchange connector.ExchangeName
//   - marketID connectorprediction.MarketID
//   - outcomeID connectorprediction.OutcomeID
...
func (_c *MarketStore_GetOrderBook_Call) Run(run func(exchange connector.ExchangeName, marketID connectorprediction.MarketID, outcomeID connectorprediction.OutcomeID)) *MarketStore_GetOrderBook_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(connector.ExchangeName), args[1].(connectorprediction.MarketID), args[2].(connectorprediction.OutcomeID))
	})
	return _c
}
...
func (_c *MarketStore_GetOrderBook_Call) RunAndReturn(run func(connector.ExchangeName, connectorprediction.MarketID, connectorprediction.OutcomeID) *connector.OrderBook) *MarketStore_GetOrderBook_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MarketStore) UpdateOrderBook(exchange connector.ExchangeName, marketID connectorprediction.MarketID, outcomeID connectorprediction.OutcomeID, orderBook connector.OrderBook) {
...
func (_c *MarketStore_UpdateOrderBook_Call) Run(run func(exchange connector.ExchangeName, marketID connectorprediction.MarketID, outcomeID connectorprediction.OutcomeID, orderBook connector.OrderBook)) *MarketStore_UpdateOrderBook_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(connector.ExchangeName), args[1].(connectorprediction.MarketID), args[2].(connectorprediction.OutcomeID), args[3].(connector.OrderBook))
	})
	return _c
}
...
func (_c *MarketStore_UpdateOrderBook_Call) RunAndReturn(run func(connector.ExchangeName, connectorprediction.MarketID, connectorprediction.OutcomeID, connector.OrderBook)) *MarketStore_UpdateOrderBook_Call {
	_c.Run(run)
	return _c
}

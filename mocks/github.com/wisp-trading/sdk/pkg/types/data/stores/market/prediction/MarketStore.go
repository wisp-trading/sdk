...
func (_m *MarketStore) GetMarketOrderBooks(exchange connector.ExchangeName, marketID typesconnector.MarketID) prediction.OutcomeOrderBookMap {
...
func (_c *MarketStore_GetMarketOrderBooks_Call) RunAndReturn(run func(connector.ExchangeName, typesconnector.MarketID) prediction.OutcomeOrderBookMap) *MarketStore_GetMarketOrderBooks_Call {
	_c.Call.Return(run)
	return _c
}

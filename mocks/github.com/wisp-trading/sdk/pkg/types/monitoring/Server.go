...
// SocketPath provides a mock function with no fields
func (_m *Server) SocketPath() string {
	ret := _m.Called()
...
func (_c *Server_SocketPath_Call) Return(_a0 string) *Server_SocketPath_Call {
	_c.Call.Return(_a0)
	return _c
}
...
func (_c *Server_Stop_Call) RunAndReturn(run func(context.Context) error) *Server_Stop_Call {
	_c.Call.Return(run)
	return _c
}

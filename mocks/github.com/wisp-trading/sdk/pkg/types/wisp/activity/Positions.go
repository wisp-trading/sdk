...
// GetStrategyExecution provides a mock function with given fields: name
func (_m *Positions) GetStrategyExecution(name strategy.StrategyName) *strategy.StrategyExecution {
	ret := _m.Called(name)
...
func (_e *Positions_Expecter) GetStrategyExecution(name interface{}) *Positions_GetStrategyExecution_Call {
	return &Positions_GetStrategyExecution_Call{Call: _e.mock.On("GetStrategyExecution", name)}
}

func (_c *Positions_GetStrategyExecution_Call) Run(run func(name strategy.StrategyName)) *Positions_GetStrategyExecution_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
// GetTradesForStrategy provides a mock function with given fields: name
func (_m *Positions) GetTradesForStrategy(name strategy.StrategyName) []connector.Trade {
	ret := _m.Called(name)
...
//   - name strategy.StrategyName
func (_e *Positions_Expecter) GetTradesForStrategy(name interface{}) *Positions_GetTradesForStrategy_Call {
	return &Positions_GetTradesForStrategy_Call{Call: _e.mock.On("GetTradesForStrategy", name)}
}

func (_c *Positions_GetTradesForStrategy_Call) Run(run func(name strategy.StrategyName)) *Positions_GetTradesForStrategy_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(strategy.StrategyName))
	})
	return _c

...
func (_c *AccountReader_GetBalance_Call) Return(_a0 *connector.AssetBalance, _a1 error) *AccountReader_GetBalance_Call {
...
func (_m *AccountReader) GetTradingHistory(pair portfolio.Pair, limit int) ([]connector.Trade, error) {
...
func (_c *AccountReader_GetTradingHistory_Call) RunAndReturn(run func(portfolio.Pair, int) ([]connector.Trade, error)) *AccountReader_GetTradingHistory_Call {
	_c.Call.Return(run)
	return _c
}

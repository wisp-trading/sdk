...
// GetDataTimeRange provides a mock function with no fields
func (_m *ConnectorRegistry) GetDataTimeRange() (time.Time, time.Time, error) {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for GetDataTimeRange")
	}
...
// ConnectorRegistry_GetDataTimeRange_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetDataTimeRange'
type ConnectorRegistry_GetDataTimeRange_Call struct {
	*mock.Call
}

// GetDataTimeRange is a helper method to define mock.On call
func (_e *ConnectorRegistry_Expecter) GetDataTimeRange() *ConnectorRegistry_GetDataTimeRange_Call {
	return &ConnectorRegistry_GetDataTimeRange_Call{Call: _e.mock.On("GetDataTimeRange")}
}

func (_c *ConnectorRegistry_GetDataTimeRange_Call) Run(run func()) *ConnectorRegistry_GetDataTimeRange_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *ConnectorRegistry_GetDataTimeRange_Call) Return(start time.Time, end time.Time, err error) *ConnectorRegistry_GetDataTimeRange_Call {
	_c.Call.Return(start, end, err)
	return _c
}

func (_c *ConnectorRegistry_GetDataTimeRange_Call) RunAndReturn(run func() (time.Time, time.Time, error)) *ConnectorRegistry_GetDataTimeRange_Call {
	_c.Call.Return(run)
	return _c
}
...
// GetTradingWebSocketConnectors provides a mock function with no fields
func (_m *ConnectorRegistry) GetTradingWebSocketConnectors() []connector.WebSocketConnector {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for GetTradingWebSocketConnectors")
	}
...
// ConnectorRegistry_GetTradingWebSocketConnectors_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetTradingWebSocketConnectors'
type ConnectorRegistry_GetTradingWebSocketConnectors_Call struct {
	*mock.Call
}

// GetTradingWebSocketConnectors is a helper method to define mock.On call
func (_e *ConnectorRegistry_Expecter) GetTradingWebSocketConnectors() *ConnectorRegistry_GetTradingWebSocketConnectors_Call {
	return &ConnectorRegistry_GetTradingWebSocketConnectors_Call{Call: _e.mock.On("GetTradingWebSocketConnectors")}
}

func (_c *ConnectorRegistry_GetTradingWebSocketConnectors_Call) Run(run func()) *ConnectorRegistry_GetTradingWebSocketConnectors_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *ConnectorRegistry_GetTradingWebSocketConnectors_Call) Return(_a0 []connector.WebSocketConnector) *ConnectorRegistry_GetTradingWebSocketConnectors_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *ConnectorRegistry_GetTradingWebSocketConnectors_Call) RunAndReturn(run func() []connector.WebSocketConnector) *ConnectorRegistry_GetTradingWebSocketConnectors_Call {
	_c.Call.Return(run)
	return _c
}
